...
TEST(Material, Read) {
    ...
    ASSERT_EQ(material.mParameters.size(), 11); {
        ...
        ASSERT_EQ(material.mParameters[0].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[1].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[2].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[3].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[4].mType, ValueType::kValue);
        ...
        ASSERT_EQ(material.mParameters[5].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[6].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[7].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[8].mType, ValueType::kValue);
        ...
        ASSERT_EQ(material.mParameters[9].mType, ValueType::kColor);
        ...
        ASSERT_EQ(material.mParameters[10].mType, ValueType::kKey);
