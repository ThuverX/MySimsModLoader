...
public:
    ...
    void draw() override {
        if (ImGui::Begin((mName + "##window_lua").c_str(), &mIsVisible)) {
            const bool inputEnter = ImGui::InputText("##input", mLuaInputBuf, sizeof(mLuaInputBuf), ImGuiInputTextFlags_EnterReturnsTrue);
            ImGui::SameLine();

            if (ImGui::Button("Run") || inputEnter) {
                ...
                if (Msml::Core::Hooks::LuaHook::RunString(code)) {
                    ...
                    mLuaOutput = nullptr;
                    Msml::Core::Hooks::LuaHook::sLuaError = "";
                    lua_pop(L, 1);
                }
            ...
            if (ImGui::Button("RELOAD LUA")) {
                Msml::Core::Hooks::LuaHook::Reload();
            }
            ...
            if (mLuaOutput != nullptr) {
                ...
                ImGui::TextUnformatted(Msml::Core::Hooks::LuaHook::sLuaError.c_str());
            }
        }
        ImGui::End();
    };
