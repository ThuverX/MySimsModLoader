...
// This is an edited version of IGraphics.h from TheForge
// Doing this is pretty bad, but it beats including the entire TheForge library
//
...
typedef void PipelineReflection;
typedef void ExtendedSettings;

enum TinyImageFormat: uint32_t {};
