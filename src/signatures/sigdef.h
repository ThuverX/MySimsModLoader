...
CREATE_NORMAL_CALLABLE_SIGNATURE_FIRST(operator_new, memory, void*, "56 57 8b 7c 24 2c 57 e8 ?? ?? ?? ?? 8b 4c 24 20 8b 54 24 18 83 c4 04 51 8b 4c 24 14 52 8b 54 24 14 51 52 8b c8", 0, uint32_t, uint32_t, uint32_t, const char*, uint32_t, uint32_t, const char*, uint32_t, uint32_t);

// exe specific
CREATE_NORMAL_CALLABLE_SIGNATURE(Rvl_Malloc, memory, void*, "56 57 8b 7c 24 24 57 e8 3a 86 de ff 8b 4c 24 18 8b 54 24 10 83 c4 04 51 52 8b c8 e8 7f 9b de ff 8b f0 6a 01 56 e8 c5 19 de ff 83 c4 08 85 f6 75 09 57 e8 4b 26 df ff 83 c4 04 5f 8b c6 5e c3", 0, uint32_t, const char*, int32_t, uint32_t, const char*, int32_t, uint32_t);
...
namespace EA {
    namespace ResourceMan {
        ...
        namespace Manager {
            ...
            CREATE_MEMBER_CALLABLE_SIGNATURE(RegisterDatabase, Manager, void, "83 EC 10 53 55 56 57 8B F9 8D 4F 48 68 2C 95 E7 00 89 4C 24 18 ?? ?? ?? ?? ?? 80 7C", 0, bool add, void* pDatabase, uint32_t priority);
        }
